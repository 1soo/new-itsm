...
> 검토 대기 목록·검토승인/반려 API(`KnowledgeReviewController`, API-KM-007/008)는 2026-07-11 제거되었다 — `common.approval.presentation.ApprovalController`(`/api/v1/approvals`)로 대체.
