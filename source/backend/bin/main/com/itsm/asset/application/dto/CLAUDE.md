...
- `AssetSummaryResponse.java` — 목록 요약 응답(만료일·만료상태 포함)
- `AssetDetailResponse.java` — 상세 응답(속성·만료(license/warranty/contract 각각 날짜+상태 OK/EXPIRING/EXPIRED)·생애주기이력·연계티켓·연결CI)
