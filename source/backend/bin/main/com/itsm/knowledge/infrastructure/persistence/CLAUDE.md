...
knowledge 도메인 리포지토리 인터페이스의 Spring Data JPA 구현체.

## 파일
- `KnowledgeArticleJpaRepository.java` — KnowledgeArticleRepository 구현(역할 기반 검색 JPQL)
- `KnowledgeCategoryJpaRepository.java` — KnowledgeCategoryRepository 구현
