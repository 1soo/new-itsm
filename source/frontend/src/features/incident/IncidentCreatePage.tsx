...
export function IncidentCreatePage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success(`인시던트가 등록되었습니다 (${created.ticketKey})`);
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4">
      <h1 className="text-xl font-semibold text-foreground">인시던트 등록</h1>
      <Card>
        <CardHeader>
          <CardTitle>새 인시던트</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="flex justify-end gap-2">
              <Button type="button" variant="outline" onClick={() => navigate("/incidents")}>취소</Button>
