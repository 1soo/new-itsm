...
> DevOps의 핵심은 사일로 해체·투명성·개발-운영 간 개방적 소통으로 비즈니스 가치 전달. ITIL과 DevOps의 전반적 비교(성격·장단점·오해)는 [01_itil.md](./01_itil.md)의 "DevOps vs ITIL" 섹션을 참고. 인시던트 관리 관점에서 DevOps가 다르게 접근하는 지점은 다음과 같다.
