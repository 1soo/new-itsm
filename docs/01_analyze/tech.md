...
|------|------|
| 2026-07-09 | 최초 작성 |
| 2026-07-10 | 확장 4개 도메인(ESM/취약점/컴플라이언스/인프라 모니터링) 추가 |
| 2026-07-14 | Backend Java 17→25·Spring Boot 3.3.5→4.1.x, Database PostgreSQL 16→18 업그레이드 |
...
| **Backend** | Spring Boot 4.1.x (Java 25) | DDD·SOLID, Spring Security 기반 인증·인가, springdoc(OpenAPI) 문서화 |
| **Database** | PostgreSQL 18 | snake_case, 정규화, 공통 컬럼 규칙 |
