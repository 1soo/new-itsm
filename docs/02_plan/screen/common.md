...
> 도메인: common · 버전: 0.8 · 작성일: 2026-07-11 · 사용자 가이드 전용 화면(SCR-COM-012, Confluence 문서 페이지 스타일, 개요=순차 렌더링/도메인·역할=아코디언 명확화, REQ-COM-002/FEAT-COM-002) 반영, 알림 드롭다운 2줄 레이아웃(도메인·상대시간/제목, REQ-COM-001/FEAT-COM-001) 반영, UI/UX 개편(ADS 기반, REQ-UIX-001~013) 반영
